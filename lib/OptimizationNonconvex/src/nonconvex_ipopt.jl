...
function __create_options(opt::NonconvexIpopt.IpoptAlg; opt_kwargs = nothing)

    options =
        !isnothing(opt_kwargs) ? NonconvexIpopt.IpoptOptions(; opt_kwargs...) :
