...
function SciMLBase.__solve(prob::OptimizationProblem, opt::Union{NLopt.Algorithm,NLopt.Opt};
    ...
    local_maxiters = GalacticOptim._check_and_convert_maxiters(local_maxiters)
    local_maxtime = GalacticOptim._check_and_convert_maxtime(local_maxtime)
    ...
    prob.sense === GalacticOptim.MaxSense ? NLopt.max_objective!(opt_setup, fg!) : NLopt.min_objective!(opt_setup, fg!)
