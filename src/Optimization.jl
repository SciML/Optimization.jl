...
function __init__()
    # AD backends
    @require FiniteDiff = "6a86dc24-6348-571c-b903-95158fe2bd41" include(
        "function/finitediff.jl",
    )
    @require ForwardDiff = "f6369f11-7733-5829-9624-2563aa707210" include(
        "function/forwarddiff.jl",
    )
    @require ReverseDiff = "37e2e3b7-166d-5795-8a7a-e32c996b4267" include(
        "function/reversediff.jl",
    )
    ...
    @require ModelingToolkit = "961ee093-0014-501f-94e3-6117800e7a78" include(
        "function/mtk.jl",
    )
end
